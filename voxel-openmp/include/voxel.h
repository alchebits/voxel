...
public:
	...
	void voxelization(unsigned procNum); // odpala proces voxelizacji obiektu. po wywolaniu metody zawiera w sobie gotowa siatke
...
private:
	Point2D setTmpPoint2D(unsigned xID, unsigned yID); // ustawia punkt na centrum odpowiadajacej siatki
	realtype calculateCellZCenter(unsigned zID, BoundingBox aabb, unsigned zRess);
